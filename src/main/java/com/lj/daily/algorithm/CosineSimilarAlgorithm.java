package com.lj.daily.algorithm;
...
public class CosineSimilarAlgorithm {
    ...
    public static void main(String args[]) {
        String str1 = "世行行长金墉：中国解决7亿人贫困问题为世界作出表率";
        String str2 = "世行行长金墉：印度解决8亿人贫困问题为世界作出贡献";

        System.out.println(CosineSimilarAlgorithm.getSimilarity(str1,str2));
    }
}
